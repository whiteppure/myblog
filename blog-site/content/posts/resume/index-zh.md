...
和相关维护，通过`easyOps`流水线持续发版更新。

#### 盛京银行-票据影像交换系统
- **时间**：2021.03～2021.05
- **职位**：Java工程师
- **简介**: 票据影像交换系统
票据影像交换系统，基于旧系统改造。新票据影像交换系统采用TCP/IP通讯，后端使用`Springboot、Netty`框架与其他系统进行交互。
*主要负责*票据影像交换系统与支付系统交互以及查询报表统计。


## 工作能力
- 熟悉面向对象编程，有良好的编码习惯;
- 具有扎实的Java基础，熟悉IO，集合、反射;
- 熟悉设计模式原则，熟练使用单例、模板、策略、适配器等设计模式;
- 熟练使用`Spring MVC、Spring、Mybatis、Spring Boot`等开源框架；
- 熟悉分布式设计与应用，熟练使用`Springboot、Redis、Kafka`技术；
- 熟悉`MySql、Oracle`,熟练使用`Sql`;能够写出基本数据报表，可以进行简单的SQL分析以及调优;
- 熟悉JVM相关知识，对JVM内存模型有深入了解;
- 熟悉`Linux`基本操作,掌握自动化运维部署基本操作;
- 熟练使用`Vue、CSS、Javascript、Jquery`等相关技术;
- 熟练使用`Maven`、`Gradle`管理依赖工具;`Git`、`Svn`版本控制工具及基本开发工具;
