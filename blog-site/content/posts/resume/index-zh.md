...
<div class="introduce_myself">
    ...
    <div class="myself_desc">
        <p>
           &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 出生于1998.9，现主要从事Java开发相关工作，从事Java开发工作经验为1年，有意向继续从事Java开发相关工作，期望找一份与之前跨度较大的工作；
           期望工作地点在北京或上海、接受出差，薪资待遇面议。
        </p>
    </div>
</div>
...
系统基于`springboot`、SSM进行开发、前后端分离开发。主要分为参数模块，设备模块等。
...
- **职位**：Java开发工程师
- **简介**:
新电子验印系统基于验印系统原型进行升级、改造。新电子验印系统采用前后端分离设计，之后前端系统集成到客户端。后端基于`springboot`等主流框架进行开发，前端基于`vue.js`进行开发，采用分布式部署。
