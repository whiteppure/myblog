...
<div class="introduce_myself">
    ...
    <div class="myself_desc">
        <p>
           &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 出生于1998，现从事Java开发工作，从事Java开发工作经验为1年，有意向继续从事Java开发相关工作，期望找一份与之前跨度较大的工作；
           现居辽宁沈阳，期望工作地点在北京或上海、接受出差，薪资待遇面议。
        </p>
    </div>
</div>
...
- **职位**: Java实习生
- **简介**:
在校期间参与老师组织的*直流远程供电后管系统*建设。
系统基于`Springboot、SSM`框架进行开发、前后端分离开发。主要分为参数模块，设备模块等。
*主要负责*Java后端设备模块及主要模块开发；负责建设后台系统功能：报表统计，导出Excel，定时任务。

### 北京利联 2019.11 ～ 至今
公司主要为金融行业提供服务，在职期间主要负责验印系统和票据影像交换系统。

#### 贵州银行-电子验印系统
- **时间**：2019.11～2020.12
- **职位**：Java工程师
- **简介**:
参与新电子验印系统从0到1的搭建，负责项目的架构设计、技术选型和整体环境搭建。新电子验印系统基于验印系统原型进行升级、改造。新电子验印系统采用前后端分离设计，之后前端系统集成到客户端。
后端基于`springboot`等主流框架进行开发，前端基于`vue.js`进行开发，采用分布式部署。
在项目担任核心，*主要负责*电子验印系统前端开发、后管系统开发、第三方系统调用接口功能开发（柜面接口服务等） 、外系统对接（集中作业系统，影像平台系统，银企对账系统等）以及同步数据程序开发，
和相关维护，通过`easyOps`流水线持续发版更新。解决过查询报表较慢等问题。

#### 盛京银行-票据影像交换系统
- **时间**：2021.03～2021.05
- **职位**：Java工程师
- **简介**: 票据影像交换系统
票据影像交换系统，基于旧系统改造。新票据影像交换系统采用socket通讯，后端使用`Springboot、Netty`框架与其他系统进行交互。
*主要负责*票据影像交换系统与支付系统交互以及查询报表统计。


## 工作能力
- 熟悉面向对象编程，有良好的编码习惯;
- 具有扎实的Java基础，熟悉IO，集合、多线程、反射;
- 熟悉设计模式原则，熟练使用单例、模板、策略、适配器等设计模式;
- 熟练使用`Spring MVC、Spring、Mybatis、Spring Boot`等开源框架；
- 熟悉分布式设计与应用，熟练使用`Springboot、Redis、Kafka、Nginx`技术；
- 熟悉`MySql、Oracle`,熟练使用`Sql`;能够写出基本数据报表，可以进行简单的SQL分析以及调优;
- 熟悉JVM相关知识，对垃圾回收原理有深入了解;
- 熟悉`Linux`基本操作,掌握自动化运维部署基本操作;
- 熟练使用`Vue、CSS、Javascript、Jquery`等相关技术;
- 熟练使用`Maven`、`Gradle`管理依赖工具;`Git`、`Svn`版本控制工具及基本软件开发工具;
- 具有良好的编码习惯对代码有”洁癖”,有一定的文档编写能力;
- 具有良好的沟通表达能力,学习及领悟能力,较强的责任心与团队精神;

## 教育经历
- `2017.09 ~ 2020.07` 就读于 *河北软件职业技术学院* 软件技术专业，学历为*专科*
- `2021.03 ~ 至今` 就读于 *辽宁工程技术大学* 计算机与科学专业，学历为*本科*
